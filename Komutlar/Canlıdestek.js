...
exports.run = async (client, message, params) => {
  ...
  var channel = client.channels.find('id', '650442612469268492')
  ...
  .setFooter("30 Saniye içinde geri dönülmezse lütfen iletişime geçin <@424640284543025153>")
